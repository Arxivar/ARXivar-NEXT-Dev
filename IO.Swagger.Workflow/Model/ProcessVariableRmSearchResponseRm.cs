...
namespace IO.Swagger.Workflow.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProcessVariableRmSearchResponseRm :  IEquatable<ProcessVariableRmSearchResponseRm>
    {
        /// <summary>
        ...
        public List<AnyOfProcessVariableRmSearchResponseRmItemsItems> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProcessVariableRmSearchResponseRm {\n");
        ...
        {
            return this.Equals(input as ProcessVariableRmSearchResponseRm);
        }

        /// <summary>
        /// Returns true if ProcessVariableRmSearchResponseRm instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessVariableRmSearchResponseRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessVariableRmSearchResponseRm input)
        {
            if (input == null)
                return false;
