...
namespace IO.Swagger.Workflow.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DiagramUpdateRm :  IEquatable<DiagramUpdateRm>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DiagramUpdateRm" /> class.
        /// </summary>
        ...
        /// <param name="descriptions">List of translation of the diagram descriptions.</param>
        /// <param name="details">List of translation of the diagram details.</param>
        /// <param name="processDeleteOption">processDeleteOption (required).</param>
        /// <param name="diagramGroupId">Diagram group identifier.</param>
        ...
        public DiagramUpdateRm(Guid? id = default(Guid?), int? priority = default(int?), string name = default(string), List<MultiLanguageValueRm> descriptions = default(List<MultiLanguageValueRm>), List<MultiLanguageValueRm> details = default(List<MultiLanguageValueRm>), ProcessDeleteOptionsRm processDeleteOption = default(ProcessDeleteOptionsRm), Guid? diagramGroupId = default(Guid?), bool? allowMultipleProcess = default(bool?), List<ProcessDocumentParameterRm> documents = default(List<ProcessDocumentParameterRm>), CalendarInfoRm calendarInfo = default(CalendarInfoRm))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DiagramUpdateRm and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("processDeleteOption is a required property for DiagramUpdateRm and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// List of translation of the diagram descriptions
        /// </summary>
        /// <value>List of translation of the diagram descriptions</value>
        [DataMember(Name="descriptions", EmitDefaultValue=false)]
        public List<MultiLanguageValueRm> Descriptions { get; set; }

        /// <summary>
        /// List of translation of the diagram details
        /// </summary>
        /// <value>List of translation of the diagram details</value>
        ...
        /// <summary>
        /// Diagram group identifier
        /// </summary>
        /// <value>Diagram group identifier</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DiagramUpdateRm {\n");
        ...
        {
            return this.Equals(input as DiagramUpdateRm);
        }

        /// <summary>
        /// Returns true if DiagramUpdateRm instances are equal
        /// </summary>
        /// <param name="input">Instance of DiagramUpdateRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiagramUpdateRm input)
        {
            if (input == null)
                return false;
