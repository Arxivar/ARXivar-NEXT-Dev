...
{
    /// <summary>
    /// OperationConfigurationDeleteProcessRm
    /// </summary>
    [DataContract]
        public partial class OperationConfigurationDeleteProcessRm : OperationsConfigurationRm,  IEquatable<OperationConfigurationDeleteProcessRm>
    {
        /// <summary>
        ...
        public ProcessDeleteOptionsRm Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OperationConfigurationDeleteProcessRm {\n");
        ...
        {
            return this.Equals(input as OperationConfigurationDeleteProcessRm);
        }

        /// <summary>
        /// Returns true if OperationConfigurationDeleteProcessRm instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationConfigurationDeleteProcessRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationConfigurationDeleteProcessRm input)
        {
            if (input == null)
                return false;
