...
namespace IO.Swagger.Workflow.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CalendarCreateRm :  IEquatable<CalendarCreateRm>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CalendarCreateRm {\n");
        ...
        {
            return this.Equals(input as CalendarCreateRm);
        }

        /// <summary>
        /// Returns true if CalendarCreateRm instances are equal
        /// </summary>
        /// <param name="input">Instance of CalendarCreateRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CalendarCreateRm input)
        {
            if (input == null)
                return false;
