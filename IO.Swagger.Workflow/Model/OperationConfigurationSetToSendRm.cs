...
{
    /// <summary>
    /// OperationConfigurationSetToSendRm
    /// </summary>
    [DataContract]
        public partial class OperationConfigurationSetToSendRm : OperationsConfigurationRm,  IEquatable<OperationConfigurationSetToSendRm>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationConfigurationSetToSendRm" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OperationConfigurationSetToSendRm {\n");
        ...
        {
            return this.Equals(input as OperationConfigurationSetToSendRm);
        }

        /// <summary>
        /// Returns true if OperationConfigurationSetToSendRm instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationConfigurationSetToSendRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationConfigurationSetToSendRm input)
        {
            if (input == null)
                return false;
