...
{
    /// <summary>
    /// Mapping from variable and sql execution
    /// </summary>
    [DataContract]
        public partial class MappingVariableSqlQueryResultItemRm :  IEquatable<MappingVariableSqlQueryResultItemRm>
    {
        /// <summary>
        ...
        public OneOfMappingVariableSqlQueryResultItemRmMapping Mapping { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MappingVariableSqlQueryResultItemRm {\n");
        ...
        {
            return this.Equals(input as MappingVariableSqlQueryResultItemRm);
        }

        /// <summary>
        /// Returns true if MappingVariableSqlQueryResultItemRm instances are equal
        /// </summary>
        /// <param name="input">Instance of MappingVariableSqlQueryResultItemRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MappingVariableSqlQueryResultItemRm input)
        {
            if (input == null)
                return false;
