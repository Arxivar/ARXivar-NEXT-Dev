...
namespace IO.Swagger.Workflow.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DiagramInfoRmSearchResponseRm :  IEquatable<DiagramInfoRmSearchResponseRm>
    {
        /// <summary>
        ...
        public List<DiagramInfoRm> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DiagramInfoRmSearchResponseRm {\n");
        ...
        {
            return this.Equals(input as DiagramInfoRmSearchResponseRm);
        }

        /// <summary>
        /// Returns true if DiagramInfoRmSearchResponseRm instances are equal
        /// </summary>
        /// <param name="input">Instance of DiagramInfoRmSearchResponseRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiagramInfoRmSearchResponseRm input)
        {
            if (input == null)
                return false;
