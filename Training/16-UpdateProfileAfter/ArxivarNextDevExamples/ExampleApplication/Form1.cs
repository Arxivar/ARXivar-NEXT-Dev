...
namespace ExampleApplication
{
    ...
    private void buttonImport_Click(object sender, EventArgs e)
        ...
        private void updprofbtn_Click(object sender, EventArgs e)
        {
            try
            {
                var profilesApi = new ...(Configuration);

                int docNumberDaModificare = int.Parse(Interaction.InputBox("Quale DOCNUMBER vuoi modificare?", "Modifica profilo", "Immetti valore"));
                var profile = profilesApi. ...(docNumberDaModificare, true);
                ...
                ((SubjectFieldDTO) oggetto).Value = "Profilo aggiornato da API";

                //Update a additional field of the profile
                var stringaProtocollo = profile.Fields.FirstOrDefault(i => i.Description.Equals("StringaProtocollo", StringComparison.CurrentCultureIgnoreCase));
                ((AdditionalFieldStringDTO)stringaProtocollo).Value = "update_api";
