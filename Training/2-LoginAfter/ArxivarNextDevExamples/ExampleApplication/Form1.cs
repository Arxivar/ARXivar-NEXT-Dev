...
namespace ExampleApplication
{
    public partial class Form1 : Form
    {
        ...
        private void LoginClick(object sender, EventArgs e)
        {
            try
            {
                //Inizializziamo "AuthenticationApi" (gli passiamo URL dell'autenticazione di Arxivar Next)
                var authApi = new ... . ... . ... . ...(_apiUrl);
                //Effettuiamo il login, passando: username dell'utente, password dell'utente, clientID, clientSecret
                var resultToken = authApi. ... (new AuthenticationTokenRequestDTO(userTxt.Text, passwordTxt.Text, _appId, _secret));

                //Mi vado a recuperare l'accessoToken e il RefreshToken
                _authToken = resultToken. ... ;
                _refreshToken = resultToken. ...;

                //Informo l'utente e visualizzo il token
