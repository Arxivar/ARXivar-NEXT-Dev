...
{
    /// <summary>
    /// VariableIntConfigurationRm
    /// </summary>
    [DataContract]
        public partial class VariableIntConfigurationRm : VariabileConfigurationRm,  IEquatable<VariableIntConfigurationRm>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VariableIntConfigurationRm {\n");
        ...
        {
            return this.Equals(input as VariableIntConfigurationRm);
        }

        /// <summary>
        /// Returns true if VariableIntConfigurationRm instances are equal
        /// </summary>
        /// <param name="input">Instance of VariableIntConfigurationRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VariableIntConfigurationRm input)
        {
            if (input == null)
                return false;
