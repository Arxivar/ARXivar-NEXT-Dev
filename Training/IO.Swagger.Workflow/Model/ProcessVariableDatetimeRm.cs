...
{
    /// <summary>
    /// ProcessVariableDatetimeRm
    /// </summary>
    [DataContract]
        public partial class ProcessVariableDatetimeRm : ProcessVariableRm,  IEquatable<ProcessVariableDatetimeRm>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProcessVariableDatetimeRm {\n");
        ...
        {
            return this.Equals(input as ProcessVariableDatetimeRm);
        }

        /// <summary>
        /// Returns true if ProcessVariableDatetimeRm instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessVariableDatetimeRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessVariableDatetimeRm input)
        {
            if (input == null)
                return false;
