...
namespace IO.Swagger.Workflow.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProcessHistoryObjectForDashboardRmSearchResponseRm :  IEquatable<ProcessHistoryObjectForDashboardRmSearchResponseRm>
    {
        /// <summary>
        ...
        public List<ProcessHistoryObjectForDashboardRm> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProcessHistoryObjectForDashboardRmSearchResponseRm {\n");
        ...
        {
            return this.Equals(input as ProcessHistoryObjectForDashboardRmSearchResponseRm);
        }

        /// <summary>
        /// Returns true if ProcessHistoryObjectForDashboardRmSearchResponseRm instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessHistoryObjectForDashboardRmSearchResponseRm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessHistoryObjectForDashboardRmSearchResponseRm input)
        {
            if (input == null)
                return false;
