...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchStringDto :  IEquatable<FieldBaseForSearchStringDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchStringDto(int? _operator = default(int?), string valore1 = default(string), string valore2 = default(string))
        {
