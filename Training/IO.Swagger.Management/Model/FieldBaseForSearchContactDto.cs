...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchContactDto :  IEquatable<FieldBaseForSearchContactDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchContactDto(int? _operator = default(int?), ContactSearchFilterDto valore1 = default(ContactSearchFilterDto), ContactSearchFilterDto valore2 = default(ContactSearchFilterDto))
        {
