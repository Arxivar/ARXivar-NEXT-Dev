...
namespace IO.Swagger.Management.Model
{
    ...
    public partial class MailAccountReceiveSettingsImapDTO : MailAccountReceiveSettingsDTO,  IEquatable<MailAccountReceiveSettingsImapDTO>, IValidatableObject
    {
        ...
        public MailAccountReceiveSettingsImapDTO(string server = default(string), string username = default(string), string password = default(string), int? port = default(int?), int? connectionTimeout = default(int?), int? securityProtocol = default(int?), List<MailAccountImapFolderDTO> foldersConfiguration = default(List<MailAccountImapFolderDTO>), string className = "MailAccountReceiveSettingsImapDTO") : base(className)
        {
            this.Server = server;
