...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchDocumentTypeDto :  IEquatable<FieldBaseForSearchDocumentTypeDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchDocumentTypeDto(int? _operator = default(int?), DocumentTypeSearchFilterDto valore1 = default(DocumentTypeSearchFilterDto), DocumentTypeSearchFilterDto valore2 = default(DocumentTypeSearchFilterDto))
        {
