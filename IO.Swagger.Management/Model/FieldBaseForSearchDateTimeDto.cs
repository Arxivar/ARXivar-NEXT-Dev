...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchDateTimeDto :  IEquatable<FieldBaseForSearchDateTimeDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchDateTimeDto(int? _operator = default(int?), DateTime? valore1 = default(DateTime?), DateTime? valore2 = default(DateTime?))
        {
