...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchDoubleDto :  IEquatable<FieldBaseForSearchDoubleDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchDoubleDto(int? decimals = default(int?), int? _operator = default(int?), double? valore1 = default(double?), double? valore2 = default(double?))
        {
