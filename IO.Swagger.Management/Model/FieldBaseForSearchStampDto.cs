...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchStampDto :  IEquatable<FieldBaseForSearchStampDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchStampDto(int? _operator = default(int?), StampSearchFilterDto valore1 = default(StampSearchFilterDto), StampSearchFilterDto valore2 = default(StampSearchFilterDto))
        {
