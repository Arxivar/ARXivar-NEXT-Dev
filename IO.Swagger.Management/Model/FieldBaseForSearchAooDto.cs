...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchAooDto :  IEquatable<FieldBaseForSearchAooDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchAooDto(int? _operator = default(int?), AooSearchFilterDto valore1 = default(AooSearchFilterDto), AooSearchFilterDto valore2 = default(AooSearchFilterDto))
        {
