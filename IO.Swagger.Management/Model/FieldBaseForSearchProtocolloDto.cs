...
namespace IO.Swagger.Management.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchProtocolloDto :  IEquatable<FieldBaseForSearchProtocolloDto>, IValidatableObject
    {
        /// <summary>
        ...
        public FieldBaseForSearchProtocolloDto(int? _operator = default(int?), ProtocolSearchFilterDTO valore1 = default(ProtocolSearchFilterDTO), ProtocolSearchFilterDTO valore2 = default(ProtocolSearchFilterDTO))
        {
