...
namespace IO.Swagger.Api
{
    ...
    public partial class TaskWorkDocumentsApi : ITaskWorkDocumentsApi
    {
        ...
        /// <returns></returns>
        public TaskWorkDocumentsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< string > TaskWorkDocumentsGetTaskWorkDocumentPreviewBufferIdWithHttpInfo (int? processdocId, int? taskworkId)
        {
            ...
            if (processdocId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "processdocId", processdocId)); // query parameter
            if (taskworkId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "taskworkId", taskworkId)); // query parameter
