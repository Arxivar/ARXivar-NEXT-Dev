...
namespace IO.Swagger.Api
{
    ...
    public interface IDocumentTypesApi : IApiAccessor
    {
        ...
        /// <param name="mode">Mode of search in document types (search, archive...)</param>
        /// <param name="businessunitcode">Code of the business unit (optional)</param>
        /// <returns>List&lt;DocumentTypeBaseDTO&gt;</returns>
        List<DocumentTypeBaseDTO> DocumentTypesGet (string mode, string businessunitcode);
        ...
        ApiResponse<List<DocumentTypeBaseDTO>> DocumentTypesGetWithHttpInfo (string mode, string businessunitcode);
        /// <summary>
        /// This call return the document types that the user can view
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// This call return the document types that the user can view but in a preformatted tree with parent/child relationship
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
        ...
        /// <param name="mode">Mode of search in document types (search, archive...)</param>
        /// <param name="businessunitcode">Code of the business unit (optional)</param>
        /// <param name="forProtocol"></param>
        /// <returns>DocumentTypeBaseTreeDTO</returns>
        DocumentTypeBaseTreeDTO DocumentTypesGetTree (string mode, string businessunitcode, bool? forProtocol);
        ...
        System.Threading.Tasks.Task<List<DocumentTypeBaseDTO>> DocumentTypesGetAsync (string mode, string businessunitcode);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<DocumentTypeBaseDTO>>> DocumentTypesGetAsyncWithHttpInfo (string mode, string businessunitcode);
        /// <summary>
        /// This call return the document types that the user can view
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DocumentTypeBaseTreeDTO> DocumentTypesGetTreeAsync (string mode, string businessunitcode, bool? forProtocol);
        ...
        System.Threading.Tasks.Task<ApiResponse<DocumentTypeBaseTreeDTO>> DocumentTypesGetTreeAsyncWithHttpInfo (string mode, string businessunitcode, bool? forProtocol);
    ...
    public partial class DocumentTypesApi : IDocumentTypesApi
    {
        ...
        /// <param name="businessunitcode">Code of the business unit (optional)</param>
        /// <returns>List&lt;DocumentTypeBaseDTO&gt;</returns>
        public List<DocumentTypeBaseDTO> DocumentTypesGet (string mode, string businessunitcode)
        {
        ...
        /// <param name="businessunitcode">Code of the business unit (optional)</param>
        /// <returns>ApiResponse of List&lt;DocumentTypeBaseDTO&gt;</returns>
        public ApiResponse< List<DocumentTypeBaseDTO> > DocumentTypesGetWithHttpInfo (string mode, string businessunitcode)
        {
        ...
        /// <param name="businessunitcode">Code of the business unit (optional)</param>
        /// <returns>Task of List&lt;DocumentTypeBaseDTO&gt;</returns>
        public async System.Threading.Tasks.Task<List<DocumentTypeBaseDTO>> DocumentTypesGetAsync (string mode, string businessunitcode)
        {
        ...
        /// <param name="businessunitcode">Code of the business unit (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;DocumentTypeBaseDTO&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DocumentTypeBaseDTO>>> DocumentTypesGetAsyncWithHttpInfo (string mode, string businessunitcode)
        {
            // verify the required parameter 'mode' is set
            if (mode == null)
                throw new ApiException(400, "Missing required parameter 'mode' when calling DocumentTypesApi->DocumentTypesGet");
        ...
        /// <param name="forProtocol"></param>
        /// <returns>DocumentTypeBaseTreeDTO</returns>
        public DocumentTypeBaseTreeDTO DocumentTypesGetTree (string mode, string businessunitcode, bool? forProtocol)
        {
        ...
        /// <param name="forProtocol"></param>
        /// <returns>ApiResponse of DocumentTypeBaseTreeDTO</returns>
        public ApiResponse< DocumentTypeBaseTreeDTO > DocumentTypesGetTreeWithHttpInfo (string mode, string businessunitcode, bool? forProtocol)
        {
            // verify the required parameter 'mode' is set
            if (mode == null)
        ...
        /// <param name="forProtocol"></param>
        /// <returns>Task of DocumentTypeBaseTreeDTO</returns>
        public async System.Threading.Tasks.Task<DocumentTypeBaseTreeDTO> DocumentTypesGetTreeAsync (string mode, string businessunitcode, bool? forProtocol)
        {
        ...
        /// <param name="forProtocol"></param>
        /// <returns>Task of ApiResponse (DocumentTypeBaseTreeDTO)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DocumentTypeBaseTreeDTO>> DocumentTypesGetTreeAsyncWithHttpInfo (string mode, string businessunitcode, bool? forProtocol)
        {
            // verify the required parameter 'mode' is set
            if (mode == null)
                throw new ApiException(400, "Missing required parameter 'mode' when calling DocumentTypesApi->DocumentTypesGetTree");
