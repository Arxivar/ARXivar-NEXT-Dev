...
namespace IO.Swagger.Api
{
    ...
    public partial class PluginsApi : IPluginsApi
    {
        ...
        /// <returns></returns>
        public PluginsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< Object > PluginsPluginsGetWithHttpInfo (string pluginCode)
        {
            ...
            if (pluginCode != null) localVarPathParams.Add("pluginCode", Configuration.ApiClient.ParameterToString(pluginCode)); // path parameter
        ...
        public ApiResponse< List<ServerPluginDto> > PluginsPluginsListWithHttpInfo ()
        {
            ...
            return new ApiResponse<List<ServerPluginDto>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<ServerPluginDto>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<ServerPluginDto>)));
        }
