...
namespace IO.Swagger.Api
{
    ...
    public partial class AssociationsApi : IAssociationsApi
    {
        ...
        {
             ApiResponse<List<AssociationDTO>> localVarResponse = AssociationsInsertWithNameWithHttpInfo(name, docnumbers);
             return localVarResponse.Data;
        }
        ...
        public ApiResponse< List<AssociationDTO> > AssociationsInsertWithNameWithHttpInfo (string name, List<int?> docnumbers)
        {
            ...
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling AssociationsApi->AssociationsInsertWithName");
            // verify the required parameter 'docnumbers' is set
            if (docnumbers == null)
        ...
        {
             ApiResponse<List<AssociationDTO>> localVarResponse = await AssociationsInsertWithNameAsyncWithHttpInfo(name, docnumbers);
             return localVarResponse.Data;
        ...
        {
             AssociationsRenameWithHttpInfo(id, name);
        }
        ...
        {
             await AssociationsRenameAsyncWithHttpInfo(id, name);
