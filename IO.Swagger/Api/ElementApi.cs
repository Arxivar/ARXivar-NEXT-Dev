...
namespace IO.Swagger.Api
{
    ...
    public interface IElementApi : IApiAccessor
    {
        ...
        /// <summary>
        /// This call return all possible single element that can be used for the specific element type passed by argument
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks>
    ...
    public partial class ElementApi : IElementApi
    {
        ...
        public ApiResponse< List<KeyValueElementDto> > ElementGetByElementTypeWithHttpInfo (int? elementType)
        {
            ...
            var localVarPath = "/api/listelements/{elementType}";
