...
namespace IO.Swagger.Model
{
    ...
    public partial class RelationExploredDTO :  IEquatable<RelationExploredDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RelationExploredDTO);
        }

        /// <summary>
        /// Returns true if RelationExploredDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of RelationExploredDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelationExploredDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RootNode != null)
                    hash = hash * 59 + this.RootNode.GetHashCode();
