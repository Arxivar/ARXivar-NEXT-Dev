...
namespace IO.Swagger.Model
{
    ...
    public partial class FieldValuesArchiveCriteriaDto :  IEquatable<FieldValuesArchiveCriteriaDto>
    {
        ...
        public FieldValuesArchiveCriteriaDto(ProfileDTO SearchFilterDto = null, string FieldName = null, string FilterValue = null, string FilterId = null, List<FieldBaseForSearchDTO> Filters = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FieldValuesArchiveCriteriaDto);
        }

        /// <summary>
        /// Returns true if FieldValuesArchiveCriteriaDto instances are equal
        /// </summary>
        /// <param name="other">Instance of FieldValuesArchiveCriteriaDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldValuesArchiveCriteriaDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
