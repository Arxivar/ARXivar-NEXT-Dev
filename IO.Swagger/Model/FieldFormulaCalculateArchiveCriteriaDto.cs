...
namespace IO.Swagger.Model
{
    ...
    public partial class FieldFormulaCalculateArchiveCriteriaDto :  IEquatable<FieldFormulaCalculateArchiveCriteriaDto>
    {
        ...
        public FieldFormulaCalculateArchiveCriteriaDto(ProfileDTO SearchFilterDto = null, string FieldName = null, string Formula = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FieldFormulaCalculateArchiveCriteriaDto);
        }

        /// <summary>
        /// Returns true if FieldFormulaCalculateArchiveCriteriaDto instances are equal
        /// </summary>
        /// <param name="other">Instance of FieldFormulaCalculateArchiveCriteriaDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldFormulaCalculateArchiveCriteriaDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
