...
namespace IO.Swagger.Model
{
    ...
    public partial class TaskLayoutDetailDTO :  IEquatable<TaskLayoutDetailDTO>
    {
        ...
        public TaskLayoutDetailDTO(int? Id = null, string ElementId = null, int? X = null, int? Y = null, int? W = null, int? H = null, string InstanceId = null, int? TaskLayoutId = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaskLayoutDetailDTO);
        }

        /// <summary>
        /// Returns true if TaskLayoutDetailDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskLayoutDetailDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskLayoutDetailDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
