...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchDoubleDto : FieldBaseDTO,  IEquatable<FieldBaseForSearchDoubleDto>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FieldBaseForSearchDoubleDto);
        }

        /// <summary>
        /// Returns true if FieldBaseForSearchDoubleDto instances are equal
        /// </summary>
        /// <param name="other">Instance of FieldBaseForSearchDoubleDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldBaseForSearchDoubleDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Decimals != null)
                    hash = hash * 59 + this.Decimals.GetHashCode();
