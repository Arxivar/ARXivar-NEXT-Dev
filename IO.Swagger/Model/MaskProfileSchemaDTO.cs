...
namespace IO.Swagger.Model
{
    ...
    public partial class MaskProfileSchemaDTO :  IEquatable<MaskProfileSchemaDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MaskProfileSchemaDTO);
        }

        /// <summary>
        /// Returns true if MaskProfileSchemaDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of MaskProfileSchemaDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MaskProfileSchemaDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
