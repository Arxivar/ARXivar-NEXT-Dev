...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchConservazioneDto : FieldBaseDTO,  IEquatable<FieldBaseForSearchConservazioneDto>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FieldBaseForSearchConservazioneDto);
        }

        /// <summary>
        /// Returns true if FieldBaseForSearchConservazioneDto instances are equal
        /// </summary>
        /// <param name="other">Instance of FieldBaseForSearchConservazioneDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldBaseForSearchConservazioneDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
