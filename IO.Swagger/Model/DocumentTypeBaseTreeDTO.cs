...
namespace IO.Swagger.Model
{
    ...
    public partial class DocumentTypeBaseTreeDTO :  IEquatable<DocumentTypeBaseTreeDTO>
    {
        ...
        public DocumentTypeBaseTreeDTO(int? Id = null, int? IdParent = null, string Key = null, string Description = null, int? DocumentType = null, int? Type2 = null, int? Type3 = null, string DocState = null, int? InOut = null, List<DocumentTypeBaseTreeDTO> Childs = null, int? Pa = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocumentTypeBaseTreeDTO);
        }

        /// <summary>
        /// Returns true if DocumentTypeBaseTreeDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentTypeBaseTreeDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentTypeBaseTreeDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
