...
namespace IO.Swagger.Model
{
    ...
    public partial class ModelProfileSchemaDTO :  IEquatable<ModelProfileSchemaDTO>
    {
        ...
        /// <param name="EditModelAfterProfilation">EditModelAfterProfilation.</param>
        ...
        /// <summary>
        /// Gets or Sets EditModelAfterProfilation
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ModelProfileSchemaDTO);
        }

        /// <summary>
        /// Returns true if ModelProfileSchemaDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ModelProfileSchemaDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelProfileSchemaDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.ModelDescription.Equals(other.ModelDescription)
                ) && 
                (
                ...
                (
                    this.EditModelAfterProfilation == other.EditModelAfterProfilation ||
                    this.EditModelAfterProfilation != null &&
                    this.EditModelAfterProfilation.Equals(other.EditModelAfterProfilation)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ModelDescription != null)
                    hash = hash * 59 + this.ModelDescription.GetHashCode();
                if (this.Options != null)
                    hash = hash * 59 + this.Options.GetHashCode();
                if (this.Behaviour != null)
                    hash = hash * 59 + this.Behaviour.GetHashCode();
                if (this.EditModelAfterProfilation != null)
                    hash = hash * 59 + this.EditModelAfterProfilation.GetHashCode();
                if (this.MaskId != null)
