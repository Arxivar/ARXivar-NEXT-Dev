...
namespace IO.Swagger.Model
{
    ...
    public partial class BinderFieldDTO : FieldBaseDTO,  IEquatable<BinderFieldDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BinderFieldDTO);
        }

        /// <summary>
        /// Returns true if BinderFieldDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of BinderFieldDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BinderFieldDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
