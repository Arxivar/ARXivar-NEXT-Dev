...
namespace IO.Swagger.Model
{
    ...
    public partial class AdditionalFieldClasseDTO : FieldBaseDTO,  IEquatable<AdditionalFieldClasseDTO>
    {
        ...
        /// <param name="InsertMaskId">InsertMaskId.</param>
        /// <param name="ShowExpanded">ShowExpanded.</param>
        /// <param name="SingleElement">SingleElement.</param>
        ...
        public AdditionalFieldClasseDTO(string Name = null, string ExternalId = null, string Description = null, int? Order = null, string DataSource = null, bool? Required = null, string Formula = null, bool? Locked = null, string ComboGruppiId = null, List<DependencyFieldItem> DependencyFields = null, Dictionary<string, string> Associations = null, bool? IsAdditional = null, bool? Visible = null, string PredefinedProfileFormula = null, List<int?> Value = null, List<RowSearchResult> ComposedValues = null, DocumentTypeBaseDTO DocumentType = null, string InsertMaskId = null, bool? ShowExpanded = null, bool? SingleElement = null, List<ColumnInfo> Columns = null, AdditionalFieldTypeEnum? AdditionalFieldType = null, int? GroupId = null, int? BinderFieldId = null, int? TaskWorkVariableId = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AdditionalFieldClasseDTO);
        }

        /// <summary>
        /// Returns true if AdditionalFieldClasseDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of AdditionalFieldClasseDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalFieldClasseDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ComposedValues == other.ComposedValues ||
                    this.ComposedValues != null &&
                    this.ComposedValues.SequenceEqual(other.ComposedValues)
                ) && 
                (
                ...
                (
                    this.InsertMaskId == other.InsertMaskId ||
                    this.InsertMaskId != null &&
                    this.InsertMaskId.Equals(other.InsertMaskId)
                ) && 
                (
                    this.ShowExpanded == other.ShowExpanded ||
                    this.ShowExpanded != null &&
                    this.ShowExpanded.Equals(other.ShowExpanded)
                ) && 
                (
                    this.SingleElement == other.SingleElement ||
                    this.SingleElement != null &&
                    this.SingleElement.Equals(other.SingleElement)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ComposedValues != null)
                    hash = hash * 59 + this.ComposedValues.GetHashCode();
                if (this.DocumentType != null)
                    hash = hash * 59 + this.DocumentType.GetHashCode();
                if (this.InsertMaskId != null)
                    hash = hash * 59 + this.InsertMaskId.GetHashCode();
                if (this.ShowExpanded != null)
                    hash = hash * 59 + this.ShowExpanded.GetHashCode();
                if (this.SingleElement != null)
                    hash = hash * 59 + this.SingleElement.GetHashCode();
