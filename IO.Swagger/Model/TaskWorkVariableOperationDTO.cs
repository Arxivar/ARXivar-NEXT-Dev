...
namespace IO.Swagger.Model
{
    ...
    public partial class TaskWorkVariableOperationDTO :  IEquatable<TaskWorkVariableOperationDTO>
    {
        ...
        public TaskWorkVariableOperationDTO(List<ProcessVariableDTO> ProcessVariables = null, ProcessVariablesFieldsDTO ProcessVariablesFields = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaskWorkVariableOperationDTO);
        }

        /// <summary>
        /// Returns true if TaskWorkVariableOperationDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskWorkVariableOperationDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskWorkVariableOperationDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
