...
namespace IO.Swagger.Model
{
    ...
    public partial class DocumentDateFieldDto : FieldBaseDTO,  IEquatable<DocumentDateFieldDto>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocumentDateFieldDto);
        }

        /// <summary>
        /// Returns true if DocumentDateFieldDto instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentDateFieldDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentDateFieldDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
