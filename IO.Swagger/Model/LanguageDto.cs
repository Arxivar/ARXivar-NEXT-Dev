...
namespace IO.Swagger.Model
{
    ...
    public partial class LanguageDto :  IEquatable<LanguageDto>
    {
        ...
        public LanguageDto(string Code = null, string Description = null)
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LanguageDto);
        }

        /// <summary>
        /// Returns true if LanguageDto instances are equal
        /// </summary>
        /// <param name="other">Instance of LanguageDto to be compared</param>
        /// <returns>Boolean</returns>
