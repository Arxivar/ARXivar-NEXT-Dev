...
namespace IO.Swagger.Model
{
    ...
    public partial class SearchCriteriaDto :  IEquatable<SearchCriteriaDto>
    {
        ...
        public SearchCriteriaDto(int? MaxItems = null, DaAAndOrEnum? DaAAndOr = null, SearchDTO SearchFilterDto = null, SelectDTO SelectFilterDto = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SearchCriteriaDto);
        }

        /// <summary>
        /// Returns true if SearchCriteriaDto instances are equal
        /// </summary>
        /// <param name="other">Instance of SearchCriteriaDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchCriteriaDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
