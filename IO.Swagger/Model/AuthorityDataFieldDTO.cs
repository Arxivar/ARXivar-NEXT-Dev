...
namespace IO.Swagger.Model
{
    ...
    public partial class AuthorityDataFieldDTO : FieldBaseDTO,  IEquatable<AuthorityDataFieldDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AuthorityDataFieldDTO);
        }

        /// <summary>
        /// Returns true if AuthorityDataFieldDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of AuthorityDataFieldDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorityDataFieldDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
