...
namespace IO.Swagger.Model
{
    ...
    public partial class AdditionalFieldStringDTO : FieldBaseDTO,  IEquatable<AdditionalFieldStringDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AdditionalFieldStringDTO);
        }

        /// <summary>
        /// Returns true if AdditionalFieldStringDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of AdditionalFieldStringDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalFieldStringDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
