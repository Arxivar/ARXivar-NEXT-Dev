...
namespace IO.Swagger.Model
{
    ...
    public partial class FileDTO :  IEquatable<FileDTO>
    {
        ...
        public FileDTO(List<string> BufferIds = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FileDTO);
        }

        /// <summary>
        /// Returns true if FileDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of FileDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileDTO other)
        {
            ...
            return 
                (
                    this.BufferIds == other.BufferIds ||
                    this.BufferIds != null &&
                    this.BufferIds.SequenceEqual(other.BufferIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BufferIds != null)
                    hash = hash * 59 + this.BufferIds.GetHashCode();
                return hash;
            }
        }
    }
