...
namespace IO.Swagger.Model
{
    ...
    public partial class FolderPermissionsDTO :  IEquatable<FolderPermissionsDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FolderPermissionsDTO);
        }

        /// <summary>
        /// Returns true if FolderPermissionsDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of FolderPermissionsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FolderPermissionsDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
