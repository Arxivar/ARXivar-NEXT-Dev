...
namespace IO.Swagger.Model
{
    ...
    public partial class BinderPreviewFieldDTO : FieldBaseDTO,  IEquatable<BinderPreviewFieldDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BinderPreviewFieldDTO);
        }

        /// <summary>
        /// Returns true if BinderPreviewFieldDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of BinderPreviewFieldDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BinderPreviewFieldDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
