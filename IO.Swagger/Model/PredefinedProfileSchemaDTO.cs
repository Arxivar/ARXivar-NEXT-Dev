...
namespace IO.Swagger.Model
{
    ...
    public partial class PredefinedProfileSchemaDTO :  IEquatable<PredefinedProfileSchemaDTO>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PredefinedProfileSchemaDTO);
        }

        /// <summary>
        /// Returns true if PredefinedProfileSchemaDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of PredefinedProfileSchemaDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PredefinedProfileSchemaDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
